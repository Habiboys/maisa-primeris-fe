    ...
    <div className="fixed inset-0 z-[200] bg-black/40 flex items-center justify-center p-4">
      <div className="w-full max-w-5xl max-h-[90vh] bg-white rounded-2xl border border-gray-200 shadow-2xl overflow-hidden flex flex-col">
        <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between gap-3">
          <h3 className="text-lg font-semibold text-gray-900">Pilih dari Media & Upload</h3>
        ...
        <div className="p-4 overflow-y-auto flex-1">
          {isLoading ? (
            ...
            <p className="text-sm text-gray-500">Belum ada media. Upload file untuk melanjutkan.</p>
          ) : (
                ...
                return (
                  ...
                  >
                    ...
                    {isImage ? (
                      ...
                      <div className="w-full aspect-square flex flex-col items-center justify-center bg-red-50 text-red-600 p-2">
                        <FileText size={32} />
